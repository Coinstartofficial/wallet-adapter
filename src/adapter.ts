...
declare const window: {
  __CoinstartWalletInjector__: DAppInterface;
};
...
export default {
  ...
  popupWallet(): Promise<{ result: boolean }> {
    return window.__CoinstartWalletInjector__.popupWallet()
  },
  ...
  * @returns {{ result }}
  */
  hasPermissions(permissions): Promise<{ result: boolean }> {
    return window.__CoinstartWalletInjector__.hasPermissions(permissions)
  },
  ...
  * @returns {{ result }}
  */
  requestPermissions(permissions): Promise<{ result: boolean }> {
    return window.__CoinstartWalletInjector__.requestPermissions(permissions)
  },
  ...
  */
  getAccounts(): Promise<{ accounts: any[] }> {
    return window.__CoinstartWalletInjector__.getAccounts()
  },
  ...
  */
  executeMoveCall(transaction): Promise<{ result: boolean }> {
    return window.__CoinstartWalletInjector__.executeMoveCall(transaction)
  },
  ...
  */
  executeSerializedMoveCall(transactionBytes): Promise<{ result: boolean }> {
    return window.__CoinstartWalletInjector__.executeSerializedMoveCall(transactionBytes)
  }
}

// export class SuietWalletAdapter implements ISuietWalletAdapter {
//   name = '__CoinstartWalletInjector__';
